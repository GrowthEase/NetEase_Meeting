...
void CheckBoxTemplate<InheritType>::SetAttribute(const std::wstring& pstrName, const std::wstring& pstrValue) {
    if (pstrName == _T("selected"))
        Selected(pstrValue == _T("true"), true);
    else if (pstrName == _T("selectednormalimage"))
        SetSelectedStateImage(ControlStateType::NORMAL, pstrValue);
    else if (pstrName == _T("selectedhotimage"))
        SetSelectedStateImage(ControlStateType::HOT, pstrValue);
    else if (pstrName == _T("selectedpushedimage"))
        SetSelectedStateImage(ControlStateType::PUSHED, pstrValue);
    else if (pstrName == _T("selecteddisabledimage"))
        SetSelectedStateImage(ControlStateType::DISABLED, pstrValue);
    else if (pstrName == _T("selectedtextcolor")) {
        SetSelectedTextColor(pstrValue);
    } else if (pstrName == _T("selectednormalcolor"))
        SetSelectedStateColor(ControlStateType::NORMAL, pstrValue);
    else if (pstrName == _T("selectedhotcolor"))
        SetSelectedStateColor(ControlStateType::HOT, pstrValue);
    else if (pstrName == _T("selectedpushedcolor"))
        SetSelectedStateColor(ControlStateType::PUSHED, pstrValue);
    else if (pstrName == _T("selecteddisabledcolor"))
        SetSelectedStateColor(ControlStateType::DISABLED, pstrValue);
    else if (pstrName == _T("selectedforenormalimage"))
        SetSelectedForeStateImage(ControlStateType::NORMAL, pstrValue);
    else if (pstrName == _T("selectedforehotimage"))
        SetSelectedForeStateImage(ControlStateType::HOT, pstrValue);
    else if (pstrName == _T("selectedforepushedimage"))
        SetSelectedForeStateImage(ControlStateType::PUSHED, pstrValue);
    else if (pstrName == _T("selectedforedisabledimage"))
        SetSelectedForeStateImage(ControlStateType::DISABLED, pstrValue);
    else
...
void CheckBoxTemplate<InheritType>::PaintText(HDC hDC) {
    ...
    RenderEngine::DrawText(hDC, rc, GetText(), IsEnabled() ? dwTextColor : dwDisabledTextColor, m_iFont, m_uTextStyle);
}
