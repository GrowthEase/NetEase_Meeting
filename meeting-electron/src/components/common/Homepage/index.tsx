...
import { getDeviceKey, setLocalStorageCustomLangs } from '../../../utils'
...
const Homepage: React.FC = () => {
  ...
  }, [isLogined, eleIpcIns, loginLoading])
  ...
  useEffect(() => {
    ...
    if (!isLogined) {
      ...
      return () => {
        window.ipcRenderer?.off(IPCEvent.electronJoinMeeting, handleJoinMeeting)
      }
    }
  }, [isLogined])
