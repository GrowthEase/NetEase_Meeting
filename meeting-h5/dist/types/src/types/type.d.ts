...
export declare enum NEClientType {
    WEB = "web",
    ANDROID = "android",
    IOS = "ios",
    PC = "pc",
...
export declare type MembersMap = Map<string, NEMember>;
 ...
 * 初始化相关配置
 */
export declare type NEMeetingInitConfig = {
    /**
     * 是否开启日志打印(默认为true)
     */
    debug?: boolean;
...
export declare type NEIMServerConfig = {
    /**
     * lbs连接地址
     */
    lbs: string;
...
export declare type NERtcServerConfig = {
    /**
     * 通道信息服务器地址
     */
...
export declare type NEWhiteboardServerConfig = {
    /**
...
export declare type NEEncryptionType = 'none' | 'sm4-128-ecb';
/**
 * 加入会议参数配置
 */
 ...
 * 视频分辨率
 */
export declare type VideoResolution = 180 | 480 | 720 | 1080;
/**
 * 视频帧率
 */
export declare type VideoFrameRate = 5 | 10 | 15 | 20 | 25;
export declare type CreateOptions = JoinOptions;
 ...
 * icon 按钮文案
 */
export declare type BtnConfigList = BtnConfig | BtnConfig[];
/**
 * 控制栏菜单列表配置
 */
export declare type ToolBarList = ToolBar[];
export declare type MoreBar = {
    /**
     * 按钮id
     */
    id: number;
 ...
 * 更多菜单列表配置
 */
export declare type MoreBarList = MoreBar[];
export declare enum NEMeetingIdDisplayOptions {
    /**
     * 默认全部展示
     */
    displayAll = 0,
 ...
 */
export declare type EventName = 'peerJoin' | 'peerLeave' | 'roomEnded';
/**
 * 会议组件
 */
export interface NEMeetingKit {
     ...
     * @ignore
     */
    anonymousJoinMeeting: (options: JoinOptions, callback: (e?: any) => void) => void;
    /**
     * 登出接口
     * @param callback 接口回调
     */
