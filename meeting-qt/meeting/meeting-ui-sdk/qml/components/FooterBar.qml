                    ...
                    if (mainWindow.messageBubbleFullWindow === undefined) {
                        if (component.status === Component.Ready) {
                            ...
                            if (mainWindow.messageBubbleFullWindow === null) {
                                ...
                                mainWindow.messageBubbleFullWindow.x = Qt.binding(function() { return pos.x + mainWindow.x - MessageBubble.width / 2 + 30 })
                                mainWindow.messageBubbleFullWindow.y = Qt.binding(function() { return pos.y + mainWindow.y - MessageBubble.height - 2 })
                            }
                        } else {
