...
namespace ui
{
	...
	CSize VLayout::ArrangeChild(const std::vector<Control*>& m_items, UiRect rc)
	{
	...
	CSize VLayout::AjustSizeByChild(const std::vector<Control*>& m_items, CSize szAvailable)
	{
		CSize totalSize;
		CSize itemSize;
