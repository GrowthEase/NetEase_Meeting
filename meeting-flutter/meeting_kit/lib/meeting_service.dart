...
part 'src/meeting_service/model/impl/meeting_member_impl.dart';
part 'src/meeting_service/model/live_layout_type.dart';
part 'src/meeting_service/model/meeting_action.dart';
part 'src/meeting_service/model/meeting_chat.dart';
...
part 'src/meeting_service/remote/http/get_meeting_item_by_num_api.dart';
part 'src/meeting_service/remote/http/get_scheduled_members_api.dart';
...
part 'src/meeting_service/remote/http/get_web_app_list_api.dart';
part 'src/meeting_service/remote/http/get_auth_code_api.dart';
part 'src/meeting_service/remote/http/js_api_permission_api.dart';
part 'src/meeting_service/remote/http/search_contacts_api.dart';
...
part 'src/meeting_service/repository/web_app_repository.dart';
...
part 'src/meeting_service/model/contacts.dart';
...
part 'src/meeting_service/model/meeting_small_app.dart';
