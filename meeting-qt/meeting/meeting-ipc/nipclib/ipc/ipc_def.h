...
public:
    static IPCData MakeIPCData() { return std::make_shared<IPCData::element_type>(); }
    static IPCData MakeIPCData(const IPCData::element_type& data) { return std::make_shared<IPCData::element_type>(data); }
