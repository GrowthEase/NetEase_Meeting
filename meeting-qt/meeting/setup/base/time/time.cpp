...
bool Time::TimeStruct::IsValidValues() const {
    return is_in_range(month_, 1, 12) && is_in_range(day_of_week_, 0, 6) && is_in_range(day_of_month_, 1, 31) && is_in_range(hour_, 0, 23) &&
           is_in_range(minute_, 0, 59) && is_in_range(second_, 0, 60) && is_in_range(millisecond_, 0, 999);
}
