...
{
	m_pRoot->AttachBubbledEvent(ui::EventType::ALL, std::bind(&MsgForm::Notify, this, std::placeholders::_1));
...
bool MsgForm::Notify(ui::EventArgs* msg)
{
	...
	else if(msg->Type == EventType::RETURN)
	{
