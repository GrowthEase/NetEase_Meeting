...
class BASE_EXPORT FrameworkThread : public nbase::Thread
{
	friend class ThreadMap;
	friend class ThreadManager;
public:
	// custom message loop
	class CustomMessageLoop : public MessageLoop, virtual public RefCount
	{
	public:
		virtual ~CustomMessageLoop() {}
	};
	// custom message loop factory
	class CustomMessageLoopFactory : virtual public RefCount
	{
	public:
...
private:
	...
	scoped_refptr<CustomMessageLoopFactory> factory_;
