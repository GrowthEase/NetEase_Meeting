...
public:
    ...
    ///**
    // * @brief 切换语言
    // * @param language 目标语言 {@link NEMeetingLanguage}。如果设置为空，则使用当前系统语言
    // * @param int 0是成功，其他为失败
    // */
    // virtual void switchLanguage(NEMeetingLanguage language, const NEEmptyCallback& cb = NEEmptyCallback()) = 0;
