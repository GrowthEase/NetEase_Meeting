...
public:
    ...
    ITaskLoop* GetTaskLoop() const { return task_loop_; }
    ThreadID GetID() const { return id_; }

    inline Logger GetLogger() const { return logger_; }
...
public:
    static ITaskLoop* GetTaskLoop() { return tls_data_ == nullptr ? nullptr : tls_data_->GetTaskLoop(); }
    static std::string GetName() { return tls_data_ == nullptr ? "" : tls_data_->GetName(); }
    static ThreadID GetID() { return tls_data_ == nullptr ? ThreadID() : tls_data_->GetID(); }
    static ThreadTLS* GetTLSData() { return tls_data_; }
