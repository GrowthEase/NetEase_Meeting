...
import timezones_en from '../../../../locales/timezones/timezones_en'
import timezones_ja from '../../../../locales/timezones/timezones_ja'
...
import ScheduleMeetingDetail from '../ScheduleMeeting/ScheduleMeetingDetail'
import InterpreterSetting from '../../../common/Interpretation/InterpreterSetting'
...
>((props, ref) => {
  ...
  const [enableJoinBeforeHost, setEnableJoinBeforeHost] = useState(true)
  ...
  function setEditMeetingInfo(
    ...
    if (interpretationRes) {
      try {
        ...
        console.log('解析interpretation失败')
      }
    }
    ...
    form.setFieldsValue({
      ...
      interpretation,
      enableInterpretation: !!interpretation?.interpreters,
    ...
    if (meeting.scheduledMembers && meeting.scheduledMembers.length > 0) {
      ...
      if (
        userInfo?.userUuid &&
        !meeting.scheduledMembers.find(
          (item) => item.userUuid === userInfo?.userUuid
        )
      ) {
        meeting.scheduledMembers.unshift({
          userUuid: meeting?.ownerUserUuid || '',
          role: Role.host,
        })
      }

      form.setFieldValue('scheduledMembers', meeting.scheduledMembers)
          ...
          {isDetail ? (
            ...
            >
              ...
              >
                <Checkbox
                  onChange={(e) => {
                    setEnableJoinBeforeHost(e.target.checked)
                  }}
              ...
              {openAutoMute && (
                <Form.Item
                  ...
                  style={{
                    marginLeft: 24,
                    marginBottom: enableJoinBeforeHost ? 0 : 24,
                  }}
                >
...
Index.displayName = 'ScheduleMeeting'
