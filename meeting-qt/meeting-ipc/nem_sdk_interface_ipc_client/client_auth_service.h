...
public:
    ...
    virtual void onLogin(const std::string& appKey,
                         ...
                         const NEAuthService::NEAuthLoginCallback& cb) = 0;
...
class NEM_SDK_INTERFACE_EXPORT NEAuthServiceIPCClient : public NEServiceIPCClient<NEAuthServiceProcHandler, NEAuthService> {
public:
