...
public:
    virtual void onFeedback(const int& type, const std::string& path, bool needAudioDump, const NEFeedbackService::NEFeedbackCallback& cb) = 0;
};

class NEM_SDK_INTERFACE_EXPORT NEFeedbackServiceIPCClient : public NEServiceIPCClient<NEFeedbackServiceProcHandler, NEFeedbackService> {};
