...
public:
    ...
    static std::wstring GetDefaultFontName() { return m_pStrDefaultFontName; }
    ...
    static void AddPreMessage(Window* windowManagerUI) { m_aPreMessages.push_back(windowManagerUI); }
    ...
    static bool OpenResZip(void* z, unsigned int len, const std::string& password);
...
private:
    ...
    static std::wstring m_pStrResourcePath;  //ȫֵԴ·ʱ޸
    static short m_H;
    static short m_S;
    static short m_L;
