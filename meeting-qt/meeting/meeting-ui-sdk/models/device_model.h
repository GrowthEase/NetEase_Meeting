...
public:
    ...
    enum { kDeviceTypeDefault, kDeviceTypePlayout, kDeviceTypeRecord, kDeviceTypeCapture };

    enum { kDeviceName = Qt::UserRole, kDevicePath, kDeviceSelected, kDeviceDefault, kDeviceUnavailable };
