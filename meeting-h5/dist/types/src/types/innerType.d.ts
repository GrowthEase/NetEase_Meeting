...
import { NEEncryptionConfig, NEMeeting, NEMeetingInfo, NEMeetingSDK, NEMember, Role, VideoFrameRate, VideoResolution } from "./type";
...
export declare enum MeetingEventType {
    rtcChannelError = "rtcChannelError"
}
...
export declare enum memberAction {
    muteAudio = 51,
    unmuteAudio = 56,
    muteVideo = 50,
    unmuteVideo = 55,
...
export declare enum hostAction {
    remove = 0,
    muteMemberVideo = 10,
    muteMemberAudio = 11,
    muteAllAudio = 12,
...
export declare type NERoomChatMessageType = 'text' | 'image' | 'audio' | 'video' | 'file' | 'geo' | 'custom' | 'tip' | 'notification';
/**
 * 房间内聊天消息
 */
...
export declare type Dispatch = (params: Action<ActionType>) => void;
export interface GlobalContext {
    ...
    globalConfig?: GetMeetingConfigResponse;
    showMeetingRemainingTip?: boolean;
    waitingRejoinMeeting?: boolean;
    online?: boolean;
}
export declare type GetMeetingConfigResponse = {
    deviceConfig?: any;
    appConfig: {
        APP_ROOM_RESOURCE: {
            whiteboard: boolean;
...
export interface ActionHandle {
    ...
    [ActionType.UPDATE_MEMBER]: {
        uuid: string;
        member: Partial<NEMember>;
    };
    [ActionType.DELETE_MEMBER_PROPERTIES]: {
        uuid: string;
        properties: string[];
    };
...
export declare type ActionHandleType<T extends ActionType> = ActionHandle[T];
...
export declare type MeetingAccountInfo = {
    nickname: string;
    privateMeetingNum: string;
    shortMeetingNum: string;
};
...
export declare enum SingleMeunIds {
    participants = 3,
    manageParticipants = 4,
    invite = 20,
    chat = 21
}
export declare enum MutipleMenuIds {
    mic = 0,
    camera = 1,
    screenShare = 2,
    gallery = 5,
