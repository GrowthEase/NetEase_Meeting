...
public:
    virtual bool onStartMeeting(const NEStartMeetingParams& param,
                                const NEStartMeetingOptions& opts,
                                const NEMeetingService::NEStartMeetingCallback& cb) = 0;
    virtual bool onJoinMeeting(const NEJoinMeetingParams& param,
                               const NEJoinMeetingOptions& opts,
                               const NEMeetingService::NEJoinMeetingCallback& cb) = 0;
    virtual bool onAnonymousJoinMeeting(const NEJoinMeetingParams& param,
                                        const NEJoinMeetingOptions& opts,
                                        const NEMeetingService::NEJoinMeetingCallback& cb) = 0;
...
class NEM_SDK_INTERFACE_EXPORT NEMeetingServiceIPCClient : public NEServiceIPCClient<NEMeetingServiceProcHandler, NEMeetingService> {
public:
