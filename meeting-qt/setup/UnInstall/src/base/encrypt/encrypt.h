...
class EncryptMethodInterface : public nbase::RefCount
{
public:
...
typedef nbase::scoped_refptr<EncryptMethodInterface>  EncryptMethodInterface_var;
...
public:
	...
	virtual bool AddMethod(nbase::EncryptMethodInterface *method) = 0;
...
typedef nbase::scoped_refptr<EncryptInterface>        EncryptInterface_var;
