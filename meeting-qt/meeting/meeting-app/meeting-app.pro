...
DEFINES += QT_DEPRECATED_WARNINGS UNICODE
...
win32 {
    ...
    CONFIG(debug, debug|release) {
        !contains(QMAKE_TARGET.arch, x86_64) {
            ...
            LIBS += -L$$PWD/third_party/neplauncher/libs/x86/Debug -lNEPLauncher
        } else {
            LIBS += -L$$PWD/../third_party_libs/alog/lib/x64/Debug -lyx_alog
            LIBS += -L$$PWD/third_party/neplauncher/libs/x64/Debug -lNEPLauncher
        }
        ...
        !contains(QMAKE_TARGET.arch, x86_64) {
            ...
            LIBS += -L$$PWD/third_party/neplauncher/libs/x86/Release -lNEPLauncher
        } else {
            LIBS += -L$$PWD/../third_party_libs/alog/lib/x64/Release -lyx_alog
            LIBS += -L$$PWD/third_party/neplauncher/libs/x64/Release -lNEPLauncher
        }
...
macx {
    ...
    CONFIG(debug, debug|release) {
        ...
        QMS.files = $$PWD/../meeting-app/meeting-app_zh_CN.qm
...
win32 {
    HEADERS += $$PWD/../third_party/neplauncher/include/NEPLauncher.h
}
