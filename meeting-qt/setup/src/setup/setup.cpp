...
std::wstring GetAppDataPath() {
    std::wstring app_data_path = nbase::win32::GetLocalAppDataDir() + CSetupData::GetProductDoc();
...
void RegWritePca()  //把本程序添加到注册表白名单，防止弹出“这个程序可能安装不正确”
{
    ...
    if (ERROR_SUCCESS == RegOpenKeyEx(HKEY_CURRENT_USER,
                                      L"Software\\Microsoft\\Windows NT\\CurrentVersion\\AppCompatFlags\\Compatibility Assistant\\Persisted", 0,
