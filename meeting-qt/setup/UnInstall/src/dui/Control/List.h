...
public:
    Facade();
    void SetOwner(Box* pOwner) { m_pOwner = pOwner; }
...
public:
    ...
    Facade* GetFacade() { return m_Facade.get(); }

    void AttachSelect(const EventCallback& callback) { OnEvent[EventType::SELECT] += callback; }
...
public:
    ...
    void AttachUnSelect(const EventCallback& callback) { OnEvent[EventType::UNSELECT] += callback; }

    void AttachDoubleClick(const EventCallback& callback) { OnEvent[EventType::DOUBLECLICK] += callback; }
