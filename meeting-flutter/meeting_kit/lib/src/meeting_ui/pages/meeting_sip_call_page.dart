    ...
    _mobileController = TextEditingController()
      ..addListener(() {
        ...
        if (value.length >= 13) {
          ...
          /// 手机号输完整之后进行通讯录搜索
          ContactsRepository.searchContacts(null, number, 20, 0).then((value) {
            if (value.isSuccess() &&
                value.data != null &&
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                  ...
                  child: Stack(clipBehavior: Clip.none, children: <Widget>[
                    Row(children: <Widget>[
                      Text(
                        '+86',
                        style: TextStyle(
                            fontSize: 16, color: _UIColors.color_333333),
                      ),
                      Container(
                        height: 20,
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(
                                  fontSize: 16, color: _UIColors.greyB0B6BE),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle:
                        TextStyle(color: _UIColors.greyB0B6BE, fontSize: 16),
                  ),
                ),
                SizedBox(height: 50),
