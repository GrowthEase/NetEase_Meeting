...
class LocalHistoryMeetingManager with NEAccountServiceListener {
  ...
  String _getCurrentUserId() {
    ...
    final id = accountInfo.userUuid;
    final anonymous = accountInfo.isAnonymous;
    return id.isEmpty || anonymous ? '0' : id;
  }

  /// 获取该场会议最新的一次昵称
  String? getLatestNickname(String? meetingNum) {
    if (meetingNum == null) return null;
    var historyItem = localHistoryMeetingList
