...
#define LOG_IPCSERVICE(logLevel, log)                                                                                                         \
    {                                                                                                                                         \
        auto ipcService = dynamic_cast<NEMeetingSDKIMP*>(NEMeetingKit::getInstance());                                                        \
        if (ipcService) {                                                                                                                     \
            ipcService->WriteLog(logLevel,                                                                                                    \
...
class NEM_SDK_INTERFACE_EXPORT NEMeetingSDKIMP : public NEMeetingKit,
...
public:
    ...
    void switchLanguage(NEMeetingLanguage language, const NEEmptyCallback& cb);
