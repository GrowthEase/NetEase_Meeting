...
public:
    ...
    void SetHorAlignType(HorAlignType horAlignType) { m_horAlignType = horAlignType; }

    VerAlignType GetVerAlignType() const { return m_verAlignType; }
    void SetVerAlignType(VerAlignType verAlignType) { m_verAlignType = verAlignType; }
    ...
    void SetReEstimateSize(bool reEstimateSize) { m_bReEstimateSize = reEstimateSize; }
    bool GetReEstimateSize() const { return m_bReEstimateSize; }
