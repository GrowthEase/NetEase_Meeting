...
// WeakCallbackFlagһΪԱʹãҪ̳УʹòCancel()SupportWeakCallback
//ֹ̳УҪáʹĹܣ֧weakcallbackʱһĵCancel
//ȡcallbackܲûϣġʱӦʹöCancelWeakCallbackFlag͵ĳԱ
//ÿӦһcallbackһһӦĿÿ֧weakcallback
