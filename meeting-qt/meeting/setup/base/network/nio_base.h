...
enum ProxyType { kProxyTypeNone = 0, kProxyTypeSocks4, kProxyTypeSocks4A, kProxyTypeSocks5, kProxyTypeHttp11, kProxyTypeSocks5UDP };
 ...
 */
struct NIOConnectionInterface : public NIOInputAbleInterface, public NIOOutputAbleInterface, public NIOCloseAbleInterface {};

/*
 *  Purpose     Network IO client interface
 */
struct NIOClientInterface : public NIOConnectionInterface, public NIOConnectAbleInterface {};

/*
 *  Purpose     Network IO binary stream interface
 */
struct NIOBinaryStreamInterface : public NIOBinaryInputInterface, public NIOBinaryOutputInterface {};

/*
 *  Purpose     Network IO binary client interface
 */
struct NIOBinaryClientInterface : public NIOBinaryStreamInterface, public NIOClientInterface {
 ...
 */
struct NIOBinaryConnectionInterface : public NIOBinaryStreamInterface, public NIOConnectionInterface {
