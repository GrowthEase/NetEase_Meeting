...
class ClientUpdateProto extends AppHttpProtoCompat<UpgradeInfo> {
  // 账号ID，灰度升级使用
  ...
  ClientUpdateProto(
      this.accountId, this.versionName, this.versionCode, this.clientAppCode);
  ...
  @override
  String path() {
    return '${servers.baseUrl}client/latestVersion';
  }
