...
class NEMeetingKitStrings {
  ...
  static const String tryAutoLoginFailedByAccountIdOrAccountTokenEmpty =
      'accountId或者accountToken为空，自动登录失败';
  ...
  static const String meetingLocked = '会议已锁定';

  static const String meetingNotExist = '会议不存在';

  static const String reuseIMNotSupportAnonymousLogin = 'IM复用不支持匿名登录';
}
