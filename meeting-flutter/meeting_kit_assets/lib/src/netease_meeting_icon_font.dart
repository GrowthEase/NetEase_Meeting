...
class NEMeetingIconFont {
  ...
  static const IconData icon_yx_tv_duankaix = IconData(0xe768,
      fontPackage: meetingAssetsPackageName, fontFamily: _family);
  static const IconData icon_yx_tv_filpx = IconData(0xe76e,
      fontPackage: meetingAssetsPackageName, fontFamily: _family);
  ...
  static const IconData icon_yx_tv_more1x = IconData(0xe7fd,
      fontPackage: meetingAssetsPackageName, fontFamily: _family);
  static const IconData icon_earpiece1x = IconData(0xe7ff,
      fontPackage: meetingAssetsPackageName, fontFamily: _family);
  static const IconData icon_amplify = IconData(0xe800,
      fontPackage: meetingAssetsPackageName, fontFamily: _family);
  static const IconData icon_headset1x = IconData(0xe801,
      fontPackage: meetingAssetsPackageName, fontFamily: _family);
