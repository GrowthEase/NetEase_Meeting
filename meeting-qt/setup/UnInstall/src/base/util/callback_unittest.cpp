...
#include "base/util/callback_helpers.h"
#include "base/util/callback_internal.h"
...
// one-definition-rule.
template <>
struct BindState<void(void), void(void), void(FakeInvoker)> : public BindStateBase {
public:
    typedef FakeInvoker InvokerType;
};

template <>
struct BindState<void(void), void(void), void(FakeInvoker, FakeInvoker)> : public BindStateBase {
public:
    typedef FakeInvoker InvokerType;
};
}  // namespace internal
...
typedef internal::BindState<void(void), void(void), void(FakeInvoker)> FakeBindState1;
typedef internal::BindState<void(void), void(void), void(FakeInvoker, FakeInvoker)> FakeBindState2;
