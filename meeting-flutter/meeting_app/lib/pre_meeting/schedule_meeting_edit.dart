...
class _ScheduleMeetingEditRouteState
    extends MeetingBaseState<ScheduleMeetingEditRoute> {
  NEMeetingItem item;
  ...
  late TextEditingController _meetingSubjectController,
      _meetingPasswordController;
  ...
  void initState() {
    ...
    attendeeAudioSwitchOn = item.settings.isAudioControlEnable;
    liveSwitch = item.settings.live?.enable ?? false;
    liveLevelSwitch = item.settings.live?.liveWebAccessControlLevel ==
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
            ...
            suffixIcon: _focusNode.hasFocus &&
                    !TextUtil.isEmpty(_meetingSubjectController.text)
                ? ClearIconButton(
  ...
  Widget buildStartTime() {
    ...
    return buildTime(Strings.meetingStartTime, startTime, initDate, null,
        MeetingValueKey.scheduleStartTime, (DateTime dateTime) {
      setState(() {
        startTime = dateTime;
  ...
  Widget buildEndTime() {
    return buildTime(
        Strings.meetingEndTime,
        endTime,
        startTime.add(Duration(minutes: 30)),
        startTime.add(Duration(days: 1)),
        MeetingValueKey.scheduleEndTime, (DateTime dateTime) {
      setState(() {
        endTime = dateTime;
      });
    });
  ...
  Widget buildTime(String itemTitle, DateTime showTime, DateTime minTime,
      DateTime? maxTime, ValueKey key, Function function) {
    selectTime = null;
    return GestureDetector(
      key: key,
      child: Container(
  ...
  void _showCupertinoDatePicker(
      final DateTime minTime, DateTime? maxTime, Function function) {
        ...
        children: <Widget>[
          Expanded(
              ...
              child: Column(
                ...
                children: [
                  Text(Strings.meetingAttendeeAudioOff,
                      style: TextStyle(
          ...
          MeetingValueKey.addTextWidgetTest(
              valueKey: MeetingValueKey.scheduleAttendeeAudio,
