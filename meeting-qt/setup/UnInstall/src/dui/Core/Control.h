...
protected:
	...
	bool m_bNoFocus = false; //控件不需要焦点
	bool m_bClip = false;
	bool m_bGifPlay = true;//UI的开关
	...
	CursorType m_cursorType = CursorType::ARROW; //影响控件的鼠标形状
