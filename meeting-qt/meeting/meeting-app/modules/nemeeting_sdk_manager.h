...
public:
    ...
    Q_PROPERTY(QString personalShortMeetingNum READ personalShortMeetingNum WRITE setPersonalShortMeetingNum NOTIFY personalShortMeetingNumChanged)
    ...
    Q_INVOKABLE int getCurrentMeetingStatus() const;
    Q_INVOKABLE QString getInviteMeetingId() const;
    Q_INVOKABLE QString getThirdPartyCopyrightFile() const;
    ...
    QString personalShortMeetingNum() const;
    void setPersonalShortMeetingNum(const QString& shortMeetingNum);
...
signals:
    ...
    void personalShortMeetingNumChanged();
    ...
    void inviteFailed(bool inSameMeeting = false);
    void showWindow();

public slots:
    void onDockClicked();
    void onGetMeetingListUI();
    void onInitMeetingSettings();
    // void onAutoLogin();
    void onInviteByLink(const QString& meetingId);
    void onMeetingStatusChangedUI(int status, int code);

private slots:
    void onGotAccountInfo();
