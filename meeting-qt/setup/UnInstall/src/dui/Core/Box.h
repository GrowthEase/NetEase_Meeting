...
public:
    ...
    virtual void SetPadding(UiRect rcPadding);  // ڱ߾࣬൱ÿͻ
...
public:
    ...
    int GetVerScrollUnitPixels() const { return nVerScrollUnitPixels; }
    void SetVerScrollUnitPixels(int verScrollUnitPixels) { nVerScrollUnitPixels = verScrollUnitPixels; }

    bool GetScrollBarFloat() const { return m_bScrollBarFloat; }
    void SetScrollBarFloat(bool bScrollBarFloat) { m_bScrollBarFloat = bScrollBarFloat; }

    UiRect GetScrollBarPadding() const { return m_rcScrollBarPadding; }
    void SetScrollBarPadding(UiRect rcScrollBarPadding) { m_rcScrollBarPadding = rcScrollBarPadding; }

    bool GetDefaultDisplayScrollbar() const { return m_bDefaultDisplayScrollbar; }
    void SetDefaultDisplayScrollbar(bool bDefaultDisplay) { m_bDefaultDisplayScrollbar = bDefaultDisplay; }

    bool GetHoldEnd() const { return m_bHoldEnd; }
    void SetHoldEnd(bool bHoldEnd) { m_bHoldEnd = bHoldEnd; }

    void AttachScrollAppear(const EventCallback& callback) { OnEvent[EventType::SCROLLAPPEAR] += callback; }

    void AttachScrollDisappear(const EventCallback& callback) { OnEvent[EventType::SCROLLDISAPPEAR] += callback; }

    void AttachScrollUpOver(const EventCallback& callback) { OnEvent[EventType::SCROLLUPOVER] += callback; }

    void AttachScrollDownOver(const EventCallback& callback) { OnEvent[EventType::SCROLLDOWNOVER] += callback; }

    void AttachScrollChange(const EventCallback& callback) { OnEvent[EventType::SCROLLCHANGE] += callback; }
...
protected:
    ...
    bool m_bScrollProcess = false;  // ֹSetPosѭ
