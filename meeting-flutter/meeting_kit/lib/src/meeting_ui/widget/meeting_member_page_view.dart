...
class _MeetingMemberPageViewState
  ...
  String getSubject(_PageData pageData) {
    final count =
    ...
    switch (pageData.type) {
      case _MembersPageType.inMeeting:
        subject = meetingUiLocalizations.participantInMeeting;
      case _MembersPageType.waitingRoom:
        subject = meetingUiLocalizations.waiting;
      case _MembersPageType.notYetJoined:
        subject = meetingUiLocalizations.participantNotJoined;
    }
