...
class _ScheduleMeetingRouteState
    extends MeetingBaseState<ScheduleMeetingRoute> {
  ...
  void initState() {
    ...
    _meetingSubjectController = TextEditingController(
        text: '${MeetingUtil.getNickName()}${Strings.meetingSubjectSuffix}');
    callTime();
  ...
  void _showCupertinoDatePicker(
      DateTime minTime, DateTime? maxTime, Function function) {
  ...
  void _scheduleMeeting() {
    ...
    live.liveWebAccessControlLevel = liveSwitch && liveLevel
