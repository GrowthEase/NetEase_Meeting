...
Window {
    ...
    onVisibleChanged: {
        if(visible) {
            if(meetingManager.meetingInviteUrl !== '') {
                rootWindow.height += 70
            }
        } else {
            rootWindow.height = 312 + 20
        }
    }
                ...
                TextArea {
                    ...
                    text: {
                        ...
                        if ((meetingManager.meetingIdDisplayOption === MeetingStatus.DISPLAY_SHORT_ID_ONLY ||
                            ...
                            inviteInfo += meetingManager.shortMeetingNum
                            if (meetingManager.meetingIdDisplayOption !== MeetingStatus.DISPLAY_SHORT_ID_ONLY) {
                        ...
                        if (meetingManager.meetingInviteUrl !== '') {
                            inviteInfo += '\r\n'
                            inviteInfo += '\r\n'
                            inviteInfo += qsTr("InviteUrl: ") + meetingManager.meetingInviteUrl
                        }
