...
class VerifyMobileCheckCodeState extends AuthBaseState {
  ...
  Container buildNextBtn() {
    return Container(
      ...
      child: ElevatedButton(
        ...
        child: Text(
          getAppLocalizations().authNextStep,
  ...
  Container buildVerifyCodeTips() {
    return Container(
      ...
      child: Text(
        getAppLocalizations().authCheckCodeHasSendToMobile('+86-$mobile'),
  ...
  @override
  String getSubTitle() {
    return getAppLocalizations().authEnterCheckCode;
  }
  ...
  void verifyMobileCheckCodeServer() {
    ...
    lifecycleExecuteUI(result).then((result) {
      if (result?.code == HttpCode.success) {
        ...
        ErrorUtil.showError(
            context, getAppLocalizations().authVerifyCodeErrorTip);
      } else {
