...
bool GlobalManager::initialize(const QString& appKey, bool bPrivate, const QString& deviceId, const NEConfigCallback& callback) {
    ...
    m_configController->getMeetingConfig([this, appKey, callback, bPrivate](int code, const QString& msg) {
        if (0 == code) {
