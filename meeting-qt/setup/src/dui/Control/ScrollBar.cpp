...
void ScrollBar::SetAttribute(const std::wstring& pstrName, const std::wstring& pstrValue) {
    if (pstrName == _T("button1normalimage"))
        SetButton1StateImage(ControlStateType::NORMAL, pstrValue);
    else if (pstrName == _T("button1hotimage"))
        SetButton1StateImage(ControlStateType::HOT, pstrValue);
    else if (pstrName == _T("button1pushedimage"))
        SetButton1StateImage(ControlStateType::PUSHED, pstrValue);
    else if (pstrName == _T("button1disabledimage"))
        SetButton1StateImage(ControlStateType::DISABLED, pstrValue);
    else if (pstrName == _T("button2normalimage"))
        SetButton2StateImage(ControlStateType::NORMAL, pstrValue);
    else if (pstrName == _T("button2hotimage"))
        SetButton2StateImage(ControlStateType::HOT, pstrValue);
    else if (pstrName == _T("button2pushedimage"))
        SetButton2StateImage(ControlStateType::PUSHED, pstrValue);
    else if (pstrName == _T("button2disabledimage"))
        SetButton2StateImage(ControlStateType::DISABLED, pstrValue);
    else if (pstrName == _T("thumbnormalimage"))
        SetThumbStateImage(ControlStateType::NORMAL, pstrValue);
    else if (pstrName == _T("thumbhotimage"))
        SetThumbStateImage(ControlStateType::HOT, pstrValue);
    else if (pstrName == _T("thumbpushedimage"))
        SetThumbStateImage(ControlStateType::PUSHED, pstrValue);
    else if (pstrName == _T("thumbdisabledimage"))
        SetThumbStateImage(ControlStateType::DISABLED, pstrValue);
    else if (pstrName == _T("railnormalimage"))
        SetRailStateImage(ControlStateType::NORMAL, pstrValue);
    else if (pstrName == _T("railhotimage"))
        SetRailStateImage(ControlStateType::HOT, pstrValue);
    else if (pstrName == _T("railpushedimage"))
        SetRailStateImage(ControlStateType::PUSHED, pstrValue);
    else if (pstrName == _T("raildisabledimage"))
        SetRailStateImage(ControlStateType::DISABLED, pstrValue);
    else if (pstrName == _T("bknormalimage"))
        SetBkStateImage(ControlStateType::NORMAL, pstrValue);
    else if (pstrName == _T("bkhotimage"))
        SetBkStateImage(ControlStateType::HOT, pstrValue);
    else if (pstrName == _T("bkpushedimage"))
        SetBkStateImage(ControlStateType::PUSHED, pstrValue);
    else if (pstrName == _T("bkdisabledimage"))
        SetBkStateImage(ControlStateType::DISABLED, pstrValue);
    else if (pstrName == _T("hor"))
        SetHorizontal(pstrValue == _T("true"));
    else if (pstrName == _T("linesize"))
        SetLineSize(_ttoi(pstrValue.c_str()));
    else if (pstrName == _T("thumbminlength"))
        SetThumbMinLength(_ttoi(pstrValue.c_str()));
    else if (pstrName == _T("range"))
        SetScrollRange(_ttoi(pstrValue.c_str()));
    else if (pstrName == _T("value"))
        SetScrollPos(_ttoi(pstrValue.c_str()));
    else if (pstrName == _T("showbutton1"))
        SetShowButton1(pstrValue == _T("true"));
    else if (pstrName == _T("showbutton2"))
        SetShowButton2(pstrValue == _T("true"));
    else if (pstrName == _T("autohidescroll"))
        SetAutoHideScroll(pstrValue == _T("true"));
    else
...
void ScrollBar::PaintButton1(HDC hDC) {
    ...
    m_sImageModify = StringHelper::Printf(_T("dest='%d,%d,%d,%d'"), m_rcButton1.left - m_rcItem.left, m_rcButton1.top - m_rcItem.top,
                                          m_rcButton1.right - m_rcItem.left, m_rcButton1.bottom - m_rcItem.top);
...
void ScrollBar::PaintButton2(HDC hDC) {
    ...
    m_sImageModify.clear();
    m_sImageModify = StringHelper::Printf(_T("dest='%d,%d,%d,%d'"), m_rcButton2.left - m_rcItem.left, m_rcButton2.top - m_rcItem.top,
                                          m_rcButton2.right - m_rcItem.left, m_rcButton2.bottom - m_rcItem.top);
...
void ScrollBar::PaintThumb(HDC hDC) {
    ...
    m_sImageModify.clear();
    m_sImageModify = StringHelper::Printf(_T("dest='%d,%d,%d,%d'"), m_rcThumb.left - m_rcItem.left, m_rcThumb.top - m_rcItem.top,
                                          m_rcThumb.right - m_rcItem.left, m_rcThumb.bottom - m_rcItem.top);
...
void ScrollBar::PaintRail(HDC hDC) {
    ...
    m_sImageModify.clear();
    if (!m_bHorizontal) {
        m_sImageModify = StringHelper::Printf(
            _T("dest='%d,%d,%d,%d'"), m_rcThumb.left - m_rcItem.left, (m_rcThumb.top + m_rcThumb.bottom) / 2 - m_rcItem.top - m_cxyFixed.cx / 2,
            m_rcThumb.right - m_rcItem.left, (m_rcThumb.top + m_rcThumb.bottom) / 2 - m_rcItem.top + m_cxyFixed.cx - m_cxyFixed.cx / 2);
    } else {
        m_sImageModify = StringHelper::Printf(
            _T("dest='%d,%d,%d,%d'"), (m_rcThumb.left + m_rcThumb.right) / 2 - m_rcItem.left - m_cxyFixed.cy / 2, m_rcThumb.top - m_rcItem.top,
            (m_rcThumb.left + m_rcThumb.right) / 2 - m_rcItem.left + m_cxyFixed.cy - m_cxyFixed.cy / 2, m_rcThumb.bottom - m_rcItem.top);
    }
