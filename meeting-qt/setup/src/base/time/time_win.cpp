...
public:
    ...
    bool IsUsingHighResClock() { return ticks_per_microsecond_ != 0.0; }

    void DisableHighResClock() { ticks_per_microsecond_ = 0.0; }
...
private:
    ...
    int64_t ReliableNow() { return RolloverProtectedNow().ToMicroseconds(); }
