...
public:
     ...
     */
    NEException()
        : exception_code_(NEExceptionCode::kUnknown)
        , exception_message_("") {}
     ...
     */
    NEExceptionCode ExceptionCode() const { return exception_code_; }
     ...
     * @return void
     */
    void ExceptionCode(NEExceptionCode code) { exception_code_ = code; }

    /**
     * @brief 获取异常描述
     * @return std::strin 异常描述
     */
    std::string ExceptionMessage() const { return exception_message_; }
     ...
     * @return void
     */
    void ExceptionMessage(const std::string& msg) { exception_message_ = msg; }
