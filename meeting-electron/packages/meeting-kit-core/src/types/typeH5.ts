...
export interface NEMeetingKit {
   ...
   * @param callback 接口回调
   */
  login: (options: LoginOptions, callback: (e?) => void) => void
  /**
   * 匿名入会接口
   * @param options 相应配置项
   */
  anonymousJoinMeeting: (options: JoinOptions, callback: (e?) => void) => void
  /**
   * 登出接口
   * @param callback 接口回调
   */
   ...
   * @param callback 接口回调
   */
  join: (options: JoinOptions, callback: (e?) => void) => void
  /**
   * 动态更新自定义按钮
   * @param options
   */
