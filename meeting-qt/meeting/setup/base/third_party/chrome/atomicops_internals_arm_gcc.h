...
LinuxKernelCmpxchgFunc pLinuxKernelCmpxchg __attribute__((weak)) = (LinuxKernelCmpxchgFunc)0xffff0fc0;

typedef void (*LinuxKernelMemoryBarrierFunc)(void);
LinuxKernelMemoryBarrierFunc pLinuxKernelMemoryBarrier __attribute__((weak)) = (LinuxKernelMemoryBarrierFunc)0xffff0fa0;
...
inline Atomic32 NoBarrier_AtomicExchange(volatile Atomic32* ptr, Atomic32 new_value) {
    ...
    do {
        old_value = *ptr;
    } while (pLinuxKernelCmpxchg(old_value, new_value, const_cast<Atomic32*>(ptr)));
    return old_value;
}
...
inline Atomic32 Barrier_AtomicIncrement(volatile Atomic32* ptr, Atomic32 increment) {
    for (;;) {
        ...
        if (pLinuxKernelCmpxchg(old_value, new_value, const_cast<Atomic32*>(ptr)) == 0) {
