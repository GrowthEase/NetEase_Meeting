...
TcpClient::TcpClient()
    ...
    , connected_(false) {
    // create socket
    sock_ = WSASocket(AF_INET, SOCK_STREAM, IPPROTO_TCP, NULL, NULL, WSA_FLAG_OVERLAPPED);
    if (sock_ == INVALID_SOCKET) {
        DEFLOG(nbase::LogInterface::LV_ERR, __FILE__, __LINE__, "nbase::TcpClient: WSASocket() error");
    }
}
