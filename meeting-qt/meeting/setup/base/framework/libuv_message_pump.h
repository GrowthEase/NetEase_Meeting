...
#ifndef BASE_FRAMEWORK_LIBUV_MESSAGE_PUMP_H_
#define BASE_FRAMEWORK_LIBUV_MESSAGE_PUMP_H_
...
class BASE_EXPORT LibuvMessagePump : public MessagePump {
public:
    enum Event { NONE = 0, READ = 1 << 0, WRITE = 1 << 1, READ_WRITE = READ | WRITE };
...
#endif  // BASE_FRAMEWORK_LIBUV_MESSAGE_PUMP_H_
