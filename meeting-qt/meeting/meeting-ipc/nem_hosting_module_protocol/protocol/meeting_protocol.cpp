...
void StartRequest::OnPack(Json::Value& root) const {
    ...
    root["options_"]["detectMutedMic"] = options_.detectMutedMic;
    root["options_"]["unpubAudioOnMute"] = options_.unpubAudioOnMute;
...
void StartRequest::OnParse(const Json::Value& root) {
    ...
    options_.detectMutedMic = root["options_"]["detectMutedMic"].asBool();
    options_.unpubAudioOnMute = root["options_"]["unpubAudioOnMute"].asBool();
...
void GetMeetingInfoResponse::OnOtherPack(Json::Value& root) const {
    ...
    root["meetingId"] = meeting_info_.meetingNum;
    root["duration"] = meeting_info_.duration;
    root["shortMeetingNum"] = meeting_info_.shortMeetingNum;
    root["sipId"] = meeting_info_.sipId;
    root["meetingUniqueId"] = meeting_info_.meetingId;
...
void GetMeetingInfoResponse::OnOtherParse(const Json::Value& root) {
    ...
    meeting_info_.meetingNum = root["meetingId"].asString();
    meeting_info_.duration = root["duration"].asInt64();
    meeting_info_.shortMeetingNum = root["shortMeetingNum"].asString();
    meeting_info_.sipId = root["sipId"].asString();
    meeting_info_.meetingId = root["meetingUniqueId"].asInt64();
...
void PreMeetingRequest::OnPack(Json::Value& root) const {
    ...
    root["param_"]["meetingUniqueId"] = param_.meetingId;
    ...
    root["param_"]["inviteUrl"] = param_.inviteUrl;
...
void PreMeetingRequest::OnParse(const Json::Value& root) {
    ...
    param_.meetingId = root["param_"]["meetingUniqueId"].asInt64();
    ...
    param_.inviteUrl = root["param_"]["inviteUrl"].asString();
    param_.extraData = root["param_"]["extraData"].asString();
...
void GetPreMeetingListResponse::OnOtherPack(Json::Value& root) const {
    if (meeting_items.empty() == false) {
        for (auto& item : meeting_items) {
            Json::Value json_item;
            json_item["meetingId"] = item.meetingNum;
            ...
            json_item["meetingUniqueId"] = item.meetingId;
            ...
            json_item["inviteUrl"] = item.inviteUrl;
...
void GetPreMeetingListResponse::OnOtherParse(const Json::Value& root) {
    for (auto& item : root["MeetingItems"]) {
        ...
        meetingItem.meetingNum = item["meetingId"].asString();
        ...
        meetingItem.meetingId = item["meetingUniqueId"].asInt64();
        ...
        meetingItem.inviteUrl = item["inviteUrl"].asString();
