...
var MODULE_NAME = 'NEMeetingInviteService';
var seqCount = 0;
var NEMeetingInviteService = /** @class */ (function (_super) {
    __extends(NEMeetingInviteService, _super);
    function NEMeetingInviteService(_win) {
        var _this = _super.call(this, _win) || this;
        _this._listeners = [];
        _this._addListening();
        return _this;
    }
    NEMeetingInviteService.prototype.acceptInvite = function (param, opts) {
    ...
    NEMeetingInviteService.prototype.rejectInvite = function (meetingId) {
        return __awaiter(this, void 0, Promise, function () {
            var functionName, seqId;
            return __generator(this, function (_a) {
    ...
    NEMeetingInviteService.prototype.addMeetingInviteStatusListener = function (listener) {
        if (listener) {
            this._listeners.push(listener);
        }
    };
    NEMeetingInviteService.prototype.removeMeetingInviteStatusListener = function (listener) {
        var index = this._listeners.indexOf(listener);
        if (index !== -1) {
            this._listeners.splice(index, 1);
        }
    };
    NEMeetingInviteService.prototype.callOutRoomSystem = function (device) {
        return __awaiter(this, void 0, Promise, function () {
            var functionName, seqId;
            return __generator(this, function (_a) {
                functionName = 'callOutRoomSystem';
                seqId = this._generateSeqId(functionName);
                this._win.webContents.send(meeting_kit_1.BUNDLE_NAME, {
                    module: MODULE_NAME,
                    method: functionName,
    ...
    NEMeetingInviteService.prototype._addListening = function () {
        var _this = this;
    ...
    NEMeetingInviteService.prototype._generateSeqId = function (functionName) {
        seqCount++;
        return "".concat(meeting_kit_1.BUNDLE_NAME, "::").concat(MODULE_NAME, "::").concat(functionName, "::").concat(seqCount);
    };
    NEMeetingInviteService.prototype._IpcMainListener = function (seqId) {
    ...
    return NEMeetingInviteService;
}(meeting_electron_base_service_1.default));
exports.default = NEMeetingInviteService;